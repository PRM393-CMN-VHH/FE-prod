            ...
            child: productProvider.isLoading
                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isPromo = product.hasDiscount;
                      final dispPrice = isPromo
                          ? product.promoPrice!
                          : product.price;
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      product.color.isEmpty
                                          ? "Chưa cấu hình màu"
                                          : "Màu: ${flowerColorLabel(product.color)}",
...
class _FilterBottomSheetState extends State<FilterBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedColor = colorsList.contains(_selectedColor)
        ? _selectedColor
        : null;
    final textTheme = Theme.of(context).textTheme;
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            hint: Text(
              colorsList.isEmpty ? "Chưa có màu được cấu hình" : "Chọn màu",
            ),
            decoration: const InputDecoration(
