...
class AppTheme {
  ...
  static const Color backgroundColor = Color(0xFFFAF7F2); // Warm cream background
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        titleLarge: TextStyle(color: textPrimaryColor, fontSize: 18, fontWeight: FontWeight.bold),
        titleMedium: TextStyle(color: textPrimaryColor, fontSize: 16, fontWeight: FontWeight.bold),
